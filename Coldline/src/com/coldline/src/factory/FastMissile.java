...
/**
 * class when game state is at fast missile
 * @author adrian erle vega
 *
 */
public class FastMissile extends CommandFactory implements ChoiceDeterminer{
	/**
	 ...
	 */
	public FastMissile(JTextField textField, 
