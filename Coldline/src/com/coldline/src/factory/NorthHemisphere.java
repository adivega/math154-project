...
/**
 * class when game state is at north hemisphere
 * @author adrian erle vega
 *
 */
public class NorthHemisphere extends CommandFactory implements ChoiceDeterminer {
	/**
	 ...
	 */
	public NorthHemisphere(JTextField textField, 
